...
#One run
# ligands = ["sm", "metabolite", "peptide", "ion", "dna"]
# ligands_names = ["sm", "met", "pep", "ion", "dna"]
# classifiers = ["KNN"]
...
hp_dict["KNN"] = {"n_neighbors_ub": "200",
                 "n_neighbors_lb": "20"}
...
#SBATCH --mail-type=fail,time_limit\n\n""".format(classifiers_names[j],ligands_names[i], fold)
                ...
                if (classifier == "XGB"):
                    script_text = ("cat phase1_models_tuning.ipynb | ligand="+ligand+" fold="+fold+" classifier="+classifier+" trial="+trial_idx+""
